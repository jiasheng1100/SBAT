    ...
    var VisualizerUI = function (dispatcher, svg, showTooltip, overWriteModals) {
        ...
        */
        ...
        dispatcher.
            ...
            on('annotationIsAvailable', this, annotationIsAvailable).
            on('messages', this, displayMessages).
            on('displaySpanComment', this, displaySpanComment).
            on('displayArcComment', this, displayArcComment).
            on('displaySentComment', this, displaySentComment).
            on('docChanged', this, onDocChanged).
            on('hideComment', this, hideComment).
            on('showForm', this, showForm).
            on('hideForm', this, hideForm).
            on('initForm', this, initForm).
            on('collectionLoaded', this, rememberNormDb).
            ...
            on('doneRendering', this, onDoneRendering).
            on('startedRendering', this, onStartedRendering).
            on('newSourceData', this, onNewSourceData).
            on('savedSVG', this, savedSVGreceived).
            on('renderError:noFileSpecified', this, noFileSpecified).
            on('renderError:annotationFileNotFound', this, showAnnotationFileNotFound).
            on('renderError:unableToReadTextFile', this, showUnableToReadTextFile).
            on('renderError:isDirectoryError', this, reloadDirectoryWithSlash).
            on('unknownError', this, showUnknownError).
            on('keydown', this, onKeyDown).
            on('mousemove', this, onMouseMove).
            on('dblclick', this, onDblClick).
            on('click', this, onSingleClick).
            on('touchstart', this, onTouchStart).
            on('touchend', this, onTouchEnd).
            on('resize', this, onResize).
            on('searchResultsReceived', this, searchResultsReceived).
            on('clearSearch', this, clearSearch).
            on('clearSVG', this, showNoDocMessage).
